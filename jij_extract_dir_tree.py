...
import jij_extraction_from_file
...
def operation_dir_tree(lattice_const_start,
                       lattice_const_end,
                       division_num_lattice_const,
                       atomic_number_start,
                       atomic_number_end,
                       division_num_atomic_num,
                       output_file,
                       action,
                       subdir_name=None,
                       root_path=None,
                       re_calc=False):
    lattice_constants = linspace(lattice_const_start, lattice_const_end, division_num_lattice_const,
                                 endpoint=True)
    atomic_numbers = linspace(atomic_number_start, atomic_number_end, division_num_atomic_num,
                              endpoint=True)
    path_root = os.getcwd()
    ...
    for lattice_const in lattice_constants:
        for atomic_num in atomic_numbers:
            ...
            if subdir_name:
                ...
                path_destination = return_path(path_root, lattice_const_str, atomic_num_str, subdir_name)
            ...
            if action == 'make':
                ...
                with open(f'{path_destination}{input_file_name}', mode='w', encoding='utf-8') as f:
                ...
                if root_path:
                    try:
                        ...
                        path_potential_file_src = return_path(root_path, lattice_const_str, atomic_num_str)
